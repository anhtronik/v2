...
wget -q -O /usr/bin/monitor.py https://raw.githubusercontent.com/anhtronik/v2/main/LimitHandler/monitor.py
wget -q -O /usr/bin/triall_clean.py https://raw.githubusercontent.com/anhtronik/v2/main/LimitHandler/triall_clean.py
