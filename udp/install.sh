...
DB_URL="https://raw.githubusercontent.com/anhtronik/permission/main/regist"
...
# CONFIG
wget -qO /etc/zivpn/config.json https://raw.githubusercontent.com/anhtronik/v2/main/udp/config.json
